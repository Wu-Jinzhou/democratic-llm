...
DATASET="${DATASET:-artifacts/data/community_alignment/soft_panel_en.jsonl}"
OUTPUT_DIR="${OUTPUT_DIR:-checkpoints/community-alignment/llama3.1-8b-soft-en}"

require_num_train_steps

log "Training Community Alignment soft-panel English-pool model."
