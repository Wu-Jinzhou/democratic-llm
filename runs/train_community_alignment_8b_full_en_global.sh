...
DATASET="${DATASET:-artifacts/data/community_alignment/full_en_global.jsonl}"
OUTPUT_DIR="${OUTPUT_DIR:-checkpoints/community-alignment/llama3.1-8b-full-en-global}"

require_num_train_steps

log "Training Community Alignment English global-full model."
