...
FULL_GLOBAL_MODEL="${FULL_GLOBAL_MODEL:-checkpoints/community-alignment/llama3.1-8b-full-global}"
FULL_US_MODEL="${FULL_US_MODEL:-checkpoints/community-alignment/llama3.1-8b-full-us}"
SOFT_US_MODEL="${SOFT_US_MODEL:-checkpoints/community-alignment/llama3.1-8b-soft-us}"
HARD_US_MODEL="${HARD_US_MODEL:-checkpoints/community-alignment/llama3.1-8b-hard-us}"
