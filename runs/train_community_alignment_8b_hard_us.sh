...
DATASET="${DATASET:-artifacts/data/community_alignment/hard_panel_us.jsonl}"
OUTPUT_DIR="${OUTPUT_DIR:-checkpoints/community-alignment/llama3.1-8b-hard-us}"

require_num_train_steps

log "Training Community Alignment hard-panel US model."
