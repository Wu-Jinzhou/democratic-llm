...
DATASET="${DATASET:-artifacts/data/community_alignment/soft_panel_us.jsonl}"
OUTPUT_DIR="${OUTPUT_DIR:-checkpoints/community-alignment/llama3.1-8b-soft-us}"

require_num_train_steps

log "Training Community Alignment soft-panel US model."
