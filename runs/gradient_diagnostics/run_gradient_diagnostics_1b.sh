...
GRADIENT_DIAGNOSTICS_STEPS="${GRADIENT_DIAGNOSTICS_STEPS:-500}"
BOOTSTRAP_SAMPLES="${BOOTSTRAP_SAMPLES:-1000}"

OUTDIR="${OUTDIR:-artifacts/evaluations/diagnostics/gradient_hard_vs_soft_8b}"
