...
DATASET="${DATASET:-artifacts/data/global_wvs_soft_panel.jsonl}"
OUTPUT_DIR="${OUTPUT_DIR:-checkpoints/llama3.1-8b-global-wvs-soft-panel}"

log "Training PRISM global WVS soft-panel model."
