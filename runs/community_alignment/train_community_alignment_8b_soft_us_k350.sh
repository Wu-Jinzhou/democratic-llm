...
DATASET="${DATASET:-artifacts/data/community_alignment/soft_panel_us_k350.jsonl}"
OUTPUT_DIR="${OUTPUT_DIR:-checkpoints/community-alignment/llama3.1-8b-soft-us-k350}"
NUM_TRAIN_STEPS="${NUM_TRAIN_STEPS:-7014}"

require_num_train_steps

log "Training Community Alignment all-US soft-panel model (k=350)."
