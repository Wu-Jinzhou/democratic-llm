...
DATASET="${DATASET:-artifacts/data/community_alignment/hard_panel_us_k350.jsonl}"
OUTPUT_DIR="${OUTPUT_DIR:-checkpoints/community-alignment/llama3.1-8b-hard-us-k350}"
NUM_TRAIN_STEPS="${NUM_TRAIN_STEPS:-7014}"

require_num_train_steps

log "Training Community Alignment all-US hard-panel model (k=350)."
