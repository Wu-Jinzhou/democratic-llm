...
DATASET="${DATASET:-artifacts/data/community_alignment/us_balanced_subset.jsonl}"
OUTPUT_DIR="${OUTPUT_DIR:-checkpoints/community-alignment/llama3.1-8b-us-balanced-subset}"
NUM_TRAIN_STEPS="${NUM_TRAIN_STEPS:-7014}"

require_num_train_steps

log "Training Community Alignment US balanced-subset model."
