...
DATASET="${DATASET:-artifacts/data/community_alignment/full_global.jsonl}"
OUTPUT_DIR="${OUTPUT_DIR:-checkpoints/community-alignment/llama3.1-8b-full-global}"

require_num_train_steps

log "Training Community Alignment global-full model."
